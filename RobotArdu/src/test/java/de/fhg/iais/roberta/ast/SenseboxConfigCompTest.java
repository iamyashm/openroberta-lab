...
public class SenseboxConfigCompTest extends AstTest {
    ...
    public void senseBoxBrick_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=,portName=null,componentProperties={NAME1=ID1,ID1=}]]]";
    ...
    public void accelerometer_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=B,portName=null,componentProperties={}]]]";
    ...
    public void analogin_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=A2,portName=null,componentProperties={INPUT=1}]]]";
    ...
    public void analogout_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=S4,portName=null,componentProperties={OUTPUT=1}]]]";
    ...
    public void buzzer_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=S,portName=null,componentProperties={+=1}]]]";
    ...
    public void digitalin_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=A,portName=null,componentProperties={INPUT=1}]]]";
    ...
    public void digitalout_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=S3,portName=null,componentProperties={OUTPUT=1}]]]";
    ...
    public void gps_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=G3,portName=null,componentProperties={I2C=I2C}]]]";
    ...
    public void humidity_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=L3,portName=null,componentProperties={I2C=I2C}]]]";
    ...
    public void key_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=T,portName=null,componentProperties={PIN1=2}]]]";
    ...
    public void lcdi2c_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=myDisplay,portName=null,componentProperties={TITLE=P,XLABEL=X,YLABEL=Y,XSTART=0,XEND=100,YSTART=0,YEND=50,XTICK=10,YTICK=10,I2C=I2C}]]]";
    ...
    public void led_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=G,portName=null,componentProperties={INPUT=8}]]]";
    ...
    public void light_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=L2,portName=null,componentProperties={OUTPUT=1}]]]";
    ...
    public void lightveml_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=S5,portName=null,componentProperties={I2C=I2C}]]]";
    ...
    public void particle_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=S6,portName=null,componentProperties={SERIAL=Serial1}]]]";
    ...
    public void potentiometer_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=P,portName=null,componentProperties={OUTPUT=1}]]]";
    ...
    public void rgbled_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=R2,portName=null,componentProperties={RED=1,GREEN=2,BLUE=3}]]]";
    ...
    public void sdcard_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=S2,portName=null,componentProperties={NAO_FILENAME=FILE.TXT,Socket=XBEE2}]]]";
    ...
    public void sound_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=G2,portName=null,componentProperties={OUT=1}]]]";
    ...
    public void temperature_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=T2,portName=null,componentProperties={I2C=I2C}]]]";
    ...
    public void ultrasonic_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=false,userDefinedName=U,portName=null,componentProperties={TRIG=1,ECHO=2}]]]";
    ...
    public void wireless_make_ByDefault_ReturnInstanceOfConfigurationComponentClass() {
        String expectedResult = "BlockAST [project=[ConfigurationComponent[isActor=true,userDefinedName=W,portName=null,componentProperties={Socket=XBEE1}]]]";
